...
const 通用团队增益数据: 团队增益数据类型[] = [
  ...
  },
  {
    ...
    增益描述: '施展伤害招式附带一段额外伤害，最多每1.5秒触发一次，每层使无双值提升【40】点',
    增益来源: '灵素',
    团队增益类型: '治疗Buff增益',
    层数选项数组: 按数字生成数组(100),
    增益集合: [{ 属性: 属性类型.无双等级, 值: 40 }],
    支持快照增益轴: true,
  },
  {
    增益名称: '仙王蛊鼎',
  ...
  },
  {
    ...
    增益描述: '受到“号令三军”鼓舞，每层提高无双值【683】点',
    增益来源: '铁牢律',
    团队增益类型: '坦克Buff增益',
    层数选项数组: 按数字生成数组(100),
    覆盖率支持手动录入: true,
    增益集合: [{ 属性: 属性类型.无双等级, 值: (683 + 342) / 2 }],
    支持快照增益轴: true,
  },
  {
    增益名称: '禅语',
    ...
    增益描述:
      '“大狮子吼”施展后，自身每【2100】点基础体质使团队成员气血上限提高【2024】点，无双等级提高【115】点，最多100层。持续15秒。',
    增益来源: '洗髓经_奇穴',
    团队增益类型: '坦克Buff增益',
    层数选项数组: 按数字生成数组(100),
    增益集合: [
      { 属性: 属性类型.额外气血上限, 值: 2024 },
      { 属性: 属性类型.无双等级, 值: 115 },
    ],
  },
  {
    ...
    增益描述: '无双等级提高【506】点，每秒回复5%最大气血值',
    增益来源: '明尊琉璃体_朝圣言',
    团队增益类型: '坦克Buff增益',
    冲突增益: ['圣浴明心'],
    层数选项数组: 按数字生成数组(100),
    覆盖率支持手动录入: true,
    增益集合: [{ 属性: 属性类型.无双等级, 值: 506 }],
    支持快照增益轴: true,
  },
  {
    增益名称: '圣浴明心',
