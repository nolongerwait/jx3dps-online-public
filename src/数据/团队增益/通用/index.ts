...
const 通用团队增益数据: 团队增益数据类型[] = [
  ...
  },
  {
    ...
    增益描述: '施展伤害招式附带一段额外伤害，最多每1.5秒触发一次，每层使无双值提升【135】点',
    增益来源: '灵素',
    团队增益类型: '治疗Buff增益',
    层数选项数组: 按数字生成数组(100),
  ...
  },
  {
    ...
    增益描述: '每层使无双等级提高【101】点',
    增益来源: '铁骨衣',
    团队增益类型: '坦克Buff增益',
    层数选项数组: 按数字生成数组(100),
    增益集合: [{ 属性: 属性类型.无双等级, 值: 101 }],
  },
  {
    增益名称: '号令三军',
    层数: 90,
  ...
  },
  {
    ...
    增益描述:
      '“大狮子吼”施展后，自身每【2100】点基础体质使团队成员气血上限提高【2024】点，无双等级提高【126】点，最多100层。持续15秒。',
    增益来源: '洗髓经_奇穴',
    团队增益类型: '坦克Buff增益',
    层数选项数组: 按数字生成数组(100),
    增益集合: [
      { 属性: 属性类型.额外气血上限, 值: 2226 },
      { 属性: 属性类型.无双等级, 值: 126 },
    ],
  },
  {
