...
function 增益面板() {
  ...
  return (
    <div className="zengyi-wrapper" id="Guide_13">
        ...
        <div className="zengyi-title-text">
          ...
          {增益快捷设置数据?.length ? (
            <Dropdown
              ...
              placement="topLeft"
            >
              <Button size="small" style={{ marginLeft: 8, marginRight: 8 }}>
                快捷设置
              </Button>
            </Dropdown>
          ) : null}
          <计算最佳增益 保存数据并计算={保存数据并计算} />
        </div>
...
export default React.memo(增益面板)
