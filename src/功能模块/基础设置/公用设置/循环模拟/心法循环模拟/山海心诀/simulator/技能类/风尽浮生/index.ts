...
class 风尽浮生 extends 有CD技能通用类 {
  static 技能数据 = 循环模拟技能基础数据?.find((item) => item.技能名称 === '风尽浮生')
  ...
  保存释放记录() {
    const 造成buff数据 = this.获取施加重要buff信息('风尽浮生')
...
export const 引风唤灵类型 = typeof 风尽浮生
